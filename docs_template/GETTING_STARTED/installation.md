...
**The SDK Reference** can be found at https://relevanceai.readthedocs.io/en/v1.4.3
...
```bash Bash
!pip install git+https://github.com/RelevanceAI/RelevanceAI@v1.4.3
...
<figure>
<img src="https://github.com/RelevanceAI/RelevanceAI-readme-docs/blob/v1.4.3
