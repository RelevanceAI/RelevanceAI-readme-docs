...
**The SDK Reference** can be found at https://relevanceai.readthedocs.io/en/v=/
...
```bash Bash
!pip install git+https://github.com/RelevanceAI/RelevanceAI@v=
```
```bash
```
...
```bash Bash
git clone -b v= https://github.com/RelevanceAI/RelevanceAI
pip install -e .
```
```bash
```
