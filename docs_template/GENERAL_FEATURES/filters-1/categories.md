...
---
<figure>
<img src="https://github.com/RelevanceAI/RelevanceAI-readme-docs/blob/v0.33.2-getting-started/docs_template/GENERAL_FEATURES/_assests/category.png?raw=true" width="658" alt="categories.png" />
...
@@@ filter_setup, FIELD=BRAND_FIELD, FILTER_TYPE=CATEGORY_FILTER_TYPE, CONDITION=EQ_COND, CONDITION_VAL=BRAND_CATEGORY_VAL @@@
