...
<img src="https://github.com/RelevanceAI/RelevanceAI-readme-docs/blob/v2.0.0/RelevanceAI-ReadMe-docs/getting-started/RelevanceAI_Workflow_Phases.png?raw=true" width="650" alt="Relevance AI Workflow Phases" />
