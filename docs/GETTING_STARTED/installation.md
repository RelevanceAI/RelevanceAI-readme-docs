...
**The SDK Reference** can be found at https://relevanceai.readthedocs.io/en/v1.3.1
...
```bash Bash
!pip install git+https://github.com/RelevanceAI/RelevanceAI@v1.3.1
...
<figure>
<img src="https://github.com/RelevanceAI/RelevanceAI-readme-docs/blob/v1.3.1
