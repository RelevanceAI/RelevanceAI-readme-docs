...
**The SDK Reference** can be found at https://relevanceai.readthedocs.io/en/v1.1.1/
...
```bash Bash
!pip install git+https://github.com/RelevanceAI/RelevanceAI@v1.1.1
```
```bash
```
...
```bash Bash
git clone -b v1.1.1 https://github.com/RelevanceAI/RelevanceAI
pip install -e .
```
```bash
```
