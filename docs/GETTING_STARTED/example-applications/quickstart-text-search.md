...
**Try it out in Colab:** [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/RelevanceAI/RelevanceAI-readme-docs/blob/development/docs/GETTING_STARTED/example-applications/_notebooks/RelevanceAI_ReadMe_Text_search_(using_USE_VectorHub).ipynb)
